                                ...
                                <form class="col s12" method="post" action="updateProfesion.php" enctype="multipart/form-data">
                                    <div class="row espacio">
                                        ...
                                        <div class="input-field col s3">
                                            <input  id="labelId" name="idProfesion" type="text" class="validate" value="<?php echo $row[0]; ?>">
                                            <label for="labelId">idProfesion</label>
                                        </div>
                                        
                                        <!--Nombre Profesion-->
                                        <div class="input-field col s9">
                                            <input id="labelProf" name="nombre" type="text" class="validate" value="<?php echo $row[1]; ?>">
                                            <label for="labelProf">Profesion</label>
                                        </div>
