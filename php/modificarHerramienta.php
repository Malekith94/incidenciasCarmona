                ...
                <div id="contForm">
                    <div class="container" id="contenedorForm">
                        <div class="row">
                            ...
                            <?php
                                    $idHerra = $_REQUEST['idHerra'];
                                    $link = mysqli_connect("79.148.236.236", "dam42", "0260flm4448glj", "dam42_incidencias");
                                    $result = mysqli_query($link, "SELECT * FROM inventario where idHerramienta = $idHerra");
                                    $row = mysqli_fetch_row($result);
                            ?>
                                <!--Formulario-->
                                <form class="col s12" method="post" action="../updateHerramienta.php" enctype="multipart/form-data">
                                    <div class="row espacio">
                                        <!--Id Herramienta-->
                                        <div class="input-field col s3">
                                            <input  id="labelId" name="idHerra" type="text" class="validate" value="<?php echo $row[0]; ?>">
                                            <label for="labelId">Id herramienta</label>
                                        </div>

                                        <!--Nombre herramienta-->
                                        <div class="input-field col s9">
                                            <input id="labelNombre" name="nomHerra" type="text" class="validate" value="<?php echo $row[1]; ?>">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="input-field col s12">
                                            <input id="lblCantidad" name="cantHerra" type="text" class="validate" value="<?php echo $row[2]; ?>">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="file-field input-field col s12">
                                            ...
                                            <div class="file-path-wrapper">
                                                <input class="file-path validate" type="text" placeholder="<?php echo $row[3]; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
